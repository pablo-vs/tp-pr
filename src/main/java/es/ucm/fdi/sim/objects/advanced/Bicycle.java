...
public class Bicycle extends Vehicle {
	 ...
	 * 
	 * @param id
	 *            ID of this <code>Bicycle</code>.
	 * @param maxVel
	 *            Maximum velocity of this <code>Bicycle</code>.
	 * @param itinerary
	 *            Itinerary of this <code>Bicycle</code>.
	 */
	...
	/**
	 * Adjusted method that sets {@link Vehicle#brokenTime} only if
	 * {@link Vehicle#currentVel} is larger than half of {@link Vehicle#maxVel}.
	 */
	@Override
	...
	/**
	 * Adjusted method that adds the type field to the report of this
	 * <code>Bicycle</code>.
	 */
	@Override
