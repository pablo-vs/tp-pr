...
public class Junction extends SimObject {
	...
	public class IncomingRoad extends ArrayDeque<Vehicle> {
		 ...
		 * 
		 * @param road
		 *            <code>Road</code> associated to current
		 *            <code>IncomingRoad</code>.
		 */
		...
		/**
		 * Adapted add method that updates the number of <code>Vehicles</code>
		 * waiting.
		 */
		@Override
		...
		/**
		 * Adapted {@link ArrayDeque#removeFirst} method that updates the number
		 * of <code>Vehicles</code> waiting.
		 */
		@Override
		 ...
		 * 
		 * @param b
		 *            New state of the traffic light.
		 */
	 ...
	 * 
	 * @param id
	 *            ID of current <code>Junction</code>.
	 */
	 ...
	 *            ID of current <code>Junction</code>.
	 * @param incoming
	 *            List of the incoming <code>Roads</code> of this
	 *            <code>Junction</code>.
	 * @param outgoing
	 *            List of the outgoing <code>Roads</code> of this
	 *            <code>Junction</code>.
	 */
	 ...
	 * 
	 * @param v
	 *            <code>Vehicle</code> to insert into this <code>Junction</code>
	 *            .
	 */
	...
	public Vehicle vehicleOut() {
		return (currentOpenQueue == -1 || incomingRoads.size() == 0 || incomingRoads
				.get(currentOpenQueue).size() == 0) ? null : incomingRoads.get(
				currentOpenQueue).removeFirst();
	}

	/**
	 * Getter method for {@link Junction#currentOpenQueue}.
	 * 
	 * @return The index of the <code>Road</code> that currently has the traffic
	 *         light set to green.
	 */
	...
	/**
	 * Returns the <code>Road</code> joining this <code>Junction</code> and the
	 * one passed by parameter.
	 * 
	 * @param j
	 *            <code>Junction</code> to be joined to this.
	 * @return <code>Road</code> that joins this <code>Junction</code> and the
	 *         parameter.
	 * @throws UnreachableJunctionException.
	 */
	public Road getRoadToJunction(Junction j)
			throws UnreachableJunctionException {
		Road result = junctionToRoadMap.get(j);

		if (result == null) {
			throw new UnreachableJunctionException("Could not get from "
					+ getID() + " to " + j.getID());
		}
