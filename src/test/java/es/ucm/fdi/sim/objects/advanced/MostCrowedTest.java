...
public class MostCrowedTest {
	...
	public void trafficLightTest() {
		...
		new Vehicle("v1_1", 50, j1, cr);
		new Vehicle("v1_2", 50, j1, cr);
		new Vehicle("v2_1", 50, j2, cr);
		new Vehicle("v3_1", 50, j3, cr);
		new Vehicle("v3_2", 50, j3, cr);
		new Vehicle("v3_3", 50, j3, cr);
